class AppTranslations {
  ...
  static const Map<String, Map<String, String>> strings = {
    'th': {
      ...
      'dialog_too_far_title': 'ยังอยู่ไกลเกินไป',
      'dialog_too_far_dist_prefix': 'คุณอยู่ห่างจากสถานที่นี้ประมาณ ',
      'dialog_too_far_dist_suffix': '\n\nกรุณาเดินทางไปยังสถานที่ก่อนถ่ายภาพ เพื่อให้ภารกิจถูกต้อง',
      'dialog_back_to_map': 'กลับไปดูแผนที่',
    ...
    'zh': {
      ...
      'dialog_too_far_title': '距离太远了',
      'dialog_too_far_dist_prefix': '您距离该地点大约 ',
      'dialog_too_far_dist_suffix': '\n\n请前往该地点后再拍照，以完成任务。',
      'dialog_back_to_map': '返回地图',
      'map_title': '🗺️ 6大地点地图',
      'map_here': '📍 这里',
      'map_place_num': '地点 #',
      'map_done': '✓ 完成',
    ...
    'en': {
      ...
      'dialog_too_far_title': 'Too Far Away',
      'dialog_too_far_dist_prefix': 'You are approximately ',
      'dialog_too_far_dist_suffix': ' away from this location.\n\nPlease go to the location before taking a photo to complete the mission properly.',
      'dialog_back_to_map': 'Back to Map',
